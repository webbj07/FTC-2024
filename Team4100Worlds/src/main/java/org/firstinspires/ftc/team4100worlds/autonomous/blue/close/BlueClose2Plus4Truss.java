...
public class BlueClose2Plus4Truss extends ScrappyAutoBase {
    ...
    private PathChain leftSpikeMarkPath, middleSpikeMarkPath, rightSpikeMarkPath,
        backboardPath,
        backboardCyclePathOne, backboardCyclePathTwo,
        stackCyclePathOne, stackCyclePathTwo,
        endPath;

    public BlueClose2Plus4Truss() {
    ...
    public void startAuto() {
        ...
        stackCyclePathTwo = robot.m_drive.pathBuilder()
            .addPath(new BezierLine(
                backboardPath.getPath(0).getLastControlPoint(),
                new Point(35, 52)
            ))
        ...
        backboardCyclePathOne = robot.m_drive.pathBuilder()
            ...
            .addPath(new BezierLine(
                new Point(23, 59, Point.CARTESIAN),
                new Point(49, backboardCycleY, Point.CARTESIAN)
            ))
            .setConstantHeadingInterpolation(Math.PI)
        ...
        endPath = robot.m_drive.pathBuilder()
            .addPath(new Path(new BezierLine(backboardCyclePathTwo.getPath(0).getLastControlPoint(), new Point(47, 60, Point.CARTESIAN))))
            .setConstantHeadingInterpolation(Math.PI)
            .build();
