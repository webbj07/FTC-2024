...
public class FollowerConstants {
    ...
    private static final double xMovement = 70;
    private static final double yMovement = -53.6;
    ...
    public static CustomPIDFCoefficients smallTranslationalIntegral = new CustomPIDFCoefficients(
        ...
        0,
        0);
    public static double smallTranslationalPIDFFeedForward = 0.01;
    ...
    // This can be custom set for each path
    public static double pathEndHeading = 0.0035;
