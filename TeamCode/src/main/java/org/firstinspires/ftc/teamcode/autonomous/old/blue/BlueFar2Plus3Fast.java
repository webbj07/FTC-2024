...
public class BlueFar2Plus3Fast extends ScrappyAutoBase {
    ...
    public void initAuto() {
        ...
        leftBackboardTraj = robot.m_drive.actionBuilder(new Pose2d(-55.25, 35.5, Math.toRadians(180)))
                ...
                .afterDisp(16, () -> {
                    ...
                    robot.m_lift.setRelativePosition(580);
                    robot.m_conveyor.stop();
                    robot.m_intake.stop();
                })
                .splineToConstantHeading(new Vector2d(52, 42), 0)
                .build();
        ...
        middleStackTraj = robot.m_drive.actionBuilder(startingPose)
                ...
                .splineToSplineHeading(new Pose2d(-51, 34.5, Math.toRadians(180)), Math.toRadians(280))
                .build();

        middleBackboardTraj = robot.m_drive.actionBuilder(new Pose2d(-55.25, 34.5, Math.toRadians(180)))
                .lineToXConstantHeading(-50)
                .afterDisp(5, () -> {
                    robot.m_intake.raise();
                    robot.m_intake.back();
        ...
        backboardCycleTraj = robot.m_drive.actionBuilder(new Pose2d(-55.25, 35.5, Math.toRadians(180)))
                ...
                .afterDisp(20, () -> {
                    robot.m_outtake.extend(-0.07);
                    robot.m_lift.setRelativePosition(850);
                    robot.m_conveyor.stop();
                    robot.m_intake.stop();
                })
    ...
    public void startAuto() {
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        new WaitUntilCommand(() -> robot.m_lift.isWithinTolerance(780)),
