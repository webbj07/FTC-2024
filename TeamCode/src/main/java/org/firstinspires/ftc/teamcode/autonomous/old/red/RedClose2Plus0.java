...
public class RedClose2Plus0 extends ScrappyAutoBase {
    ...
    public RedClose2Plus0() {
        super(ScrappyConstants.AllianceType.RED, ScrappyConstants.AllianceSide.CLOSE, new Pose2d(15.5, -61.75, Math.toRadians(90)));
    }
    @Override
    public void initAuto() {
        // Left
        leftDetectionTraj = robot.m_drive.mirroredActionBuilder(startingPose)
                ...
                .build();
        leftEndTraj = robot.m_drive.mirroredActionBuilder(new Pose2d(52.75, 40.25, Math.toRadians(180)))
                .afterDisp(5, () -> {
        ...
        // Middle
        middleDetectionTraj = robot.m_drive.mirroredActionBuilder(startingPose)
                .stopAndAdd(robot.m_intake::lower)
                ...
                .build();
        middleEndTraj = robot.m_drive.mirroredActionBuilder(new Pose2d(52.75, 33.5, Math.toRadians(180)))
                .afterDisp(5, () -> {
                    robot.m_lift.toInitial();
                    robot.m_outtake.back();
                })
        ...
        // Right
        rightDetectionTraj = robot.m_drive.mirroredActionBuilder(startingPose)
                .stopAndAdd(robot.m_intake::lower)
                ...
                .build();
        rightEndTraj = robot.m_drive.mirroredActionBuilder(new Pose2d(52.25, 26, Math.toRadians(180)))
                .afterDisp(5, () -> {
                    robot.m_lift.toInitial();
                    robot.m_outtake.back();
                })
